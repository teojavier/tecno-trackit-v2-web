<div class="">
    <div class="p-5">
        <div class="flex ml-5">
            ...
            <a href="{{ route('categories.create') }}" class="px-3 py-2 ml-5 bg-primary text-white rounded-md ">Registrar</a>
        </div>
    </div>
                        ...
                        <table class="min-w-max w-full table-auto">
                            <thead>
                                <tr class="border bg-primary text-primary text-white uppercase text-sm leading-normal">
                                    ...
                                    <th class="border py-3 px-6 text-left">Time</th>
                                        ...
                                        <td class="py-3 px-6 text-center">
                                            <div class="flex item-center justify-center">
                                                ...
                                                <button class="focus:outline-none"
                                                    wire:click="eventDestroyCategory({{ $categoria->id }})">
                                                    <div class="w-4 mr-2 transform hover:text-primary hover:scale-110">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
